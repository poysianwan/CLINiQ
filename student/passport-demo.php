...
$conditions = ['Asthma (mild, intermittent)', 'Iron-deficiency anaemia'];
$instructions = [
    'Do not administer penicillin or sulfa-based antibiotics.',
    'Patient uses a Salbutamol inhaler. Check bag first.',
...
<body>
  ...
  <main class="pp-shell" role="main">
    ...
    <div class="pp-grid">
      <div class="pp-main">
        ...
        <section class="pp-card pp-status-card" id="incidentStatusCard" aria-label="Incident status">
          ...
          <div class="pp-timeline">
            <div class="pp-timeline-row">
              ...
              <strong id="submittedTime">-</strong>
            </div>
            <div class="pp-timeline-row">
              <span>Reporter</span>
              <strong>Emergency Tag Scanner</strong>
            </div>
            <div class="pp-timeline-row">
              <span>Photos Uploaded</span>
              <strong id="photoCount">0 attached</strong>
            </div>
            <div class="pp-timeline-row">
        ...
        <section class="pp-card pp-contact-card">
          ...
          <div class="pp-card-pad">
            ...
            <div class="pp-actions" style="margin-top:1rem;">
              ...
              <button class="pp-button pp-button-danger" type="button" id="notifyClinicBtn" aria-expanded="false" aria-controls="incidentDrawer">
                <span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>
                Notify Clinic
              </button>
            </div>
          ...
          <div class="pp-incident-drawer" id="incidentDrawer" role="region" aria-label="Incident response form">
            <div class="pp-form">
              <div>
                <label class="pp-form-label">Upload Incident Photos</label>
                <label class="pp-dropzone">
                  <input id="incidentPhotos" type="file" accept="image/*" multiple hidden>
              ...
              <div>
                ...
                <textarea class="pp-textarea" id="incidentDesc" placeholder="Describe what happened, the student condition, actions already taken, and other observations."></textarea>
              </div>

              <button class="pp-button pp-button-danger" id="submitReportBtn" type="button" style="width:100%;">
  ...
  <div class="pp-sticky-notify" aria-label="Sticky emergency action">
    <button class="pp-button pp-button-danger" type="button" id="stickyNotifyBtn" aria-expanded="false" aria-controls="incidentDrawer">
      <span class="material-symbols-outlined" aria-hidden="true">notifications_active</span>
      Notify Clinic
    </button>
  </div>
  ...
  <script>
    ...
    submitBtn.addEventListener('click', function () {
      ...
      document.getElementById('submittedTime').textContent = timeStr;
      document.getElementById('photoCount').textContent = count + (count === 1 ? ' attached' : ' attached');
      statusCard.classList.add('visible');
      drawer.classList.remove('open');

      passportStatus.style.color = 'var(--danger-dark)';
      passportStatus.style.background = 'var(--danger-soft)';
      passportStatus.style.borderColor = 'var(--danger-border)';
      passportStatus.innerHTML = '<span class="material-symbols-outlined" aria-hidden="true" style="font-size:0.9rem;">notifications_active</span>Clinic Notified';

      [notifyBtn, stickyNotifyBtn].forEach((button) => {
        button.className = 'pp-button pp-button-success';
        button.disabled = true;
        button.innerHTML = '<span class="material-symbols-outlined" aria-hidden="true">check_circle</span>Report Submitted';
      });
    });
  </script>
</body>
